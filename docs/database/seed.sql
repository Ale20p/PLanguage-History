-- =============================================================
-- Seed Data: Initial Languages, Paradigms, Creators & Connections
-- =============================================================
...
-- Python influenced by C
INSERT INTO connections (source_id, target_id, connection_type) VALUES
    ('c', 'python', 'INFLUENCED_BY');

-- JavaScript influenced by Java (syntax), Lisp/Scheme (functional)
INSERT INTO connections (source_id, target_id, connection_type) VALUES
    ('java', 'javascript', 'INFLUENCED_BY'),
    ('lisp', 'javascript', 'INFLUENCED_BY');

-- Java influenced by C++
INSERT INTO connections (source_id, target_id, connection_type) VALUES
    ('cpp', 'java', 'INFLUENCED_BY');

-- Ruby influenced by Lisp, Python
INSERT INTO connections (source_id, target_id, connection_type) VALUES
    ('lisp',   'ruby', 'INFLUENCED_BY'),
    ('python', 'ruby', 'INFLUENCED_BY');

-- Java and JavaScript both run on JVM / V8 respectively (not applicable here,
-- but showing RUNS_ON for languages that share a runtime)
-- Example: Java runs on JVM
INSERT INTO connections (source_id, target_id, connection_type) VALUES
